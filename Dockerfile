...
# NestJS outputs dist/src/main.js (rootDir "."). Also mirror src tree to dist/
# so ANY start command (generated by Railway UI, old railway.toml, or the repo)
# works: both "node dist/main" and "node dist/src/main.js" resolve correctly.
RUN cp -r dist/src/. dist/

# Create a non-root user for security
RUN addgroup -g 1001 -S nodejs && \
    adduser -S nestjs -u 1001 -G nodejs && \
    mkdir -p uploads/receipts uploads/cvs uploads/chat uploads/courses uploads/payments uploads/private/receipts uploads/private/cvs && \
