...
export default function NotFound() {
    ...
    return (
        <div className="min-h-screen bg-brand-navy-dark flex flex-col">
            <header className="px-8 py-6 flex items-center justify-between border-b border-white/5 bg-brand-navy-dark/80 backdrop-blur-md sticky top-0 z-40">
                <div className="flex items-center gap-2">
                    <div className="w-10 h-10 bg-brand-navy rounded-xl flex items-center justify-center shadow-lg shadow-black/30">
            ...
            <main className="flex-1 flex flex-col items-center justify-center px-4 text-center relative overflow-hidden">
                ...
                <div className="text-9xl font-black text-white/90 leading-none select-none">
                    4<span className="text-brand-gold">0</span>4
                </div>
                <h2 className="text-3xl lg:text-4xl font-black text-brand-gold-light mt-6">{t('notFound.title')}</h2>
                <p className="text-gray-400 mt-3 max-w-md leading-relaxed">{t('notFound.desc')}</p>
                <div className="flex flex-wrap justify-center gap-4 mt-10">
                    ...
                    <Link href="/courses" className="border-2 border-white/10 text-white px-7 py-3.5 rounded-xl font-bold hover:border-brand-gold hover:text-brand-gold-light transition-all duration-300">
                        {t('notFound.explore')}
                    </Link>
                </div>
            </main>
