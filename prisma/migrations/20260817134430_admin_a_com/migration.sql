-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'INSTRUCTOR', 'COURSE_MANAGER', 'FINANCE', 'ADMIN');
...
CREATE TABLE "Certificate" (
    ...
    "issuingDate" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
